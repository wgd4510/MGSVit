...
def main(args):
    ...
    # 创建SatVit编码器，只进行特征提取
    model = SatViT_Encode_multimodel(in_dim_s1=io_dim_s1, in_dim_s2=io_dim_s2, num_patches=patches_dim, encoder_dim=768, encoder_depth=12, encoder_num_heads=12, head_depth=args.head_depth, shortnum=args.shortnum)
