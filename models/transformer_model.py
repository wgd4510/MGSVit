...
# 经测试，效果有一点点提升,其中C4的结果最好
class BaseT_shortcut(BaseTransformer):
    def __init__(self, dim, depth, num_heads=8, attn_dropout=0., ff_dropout=0., ff_mult=4, shortnum=4):
        super().__init__(dim, depth, num_heads, attn_dropout, ff_dropout, ff_mult)
